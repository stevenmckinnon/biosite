...
const socialLinks: SocialLink[] = [
  ...
  },
  {
    ...
    color: "hover:from-gray-900 hover:to-gray-800",
  },
  {
    id: "linkedin",
    icon: (
  ...
  },
  {
    id: "facebook",
    icon: (
      <svg viewBox="0 0 128 128" className="size-5" aria-hidden="true">
        <defs>
  ...
  return (
    ...
    >
      {socialLinks.map((link, index) => (
        <BlurFade key={link.id} delay={BLUR_FADE_DELAY * 3 + index * 0.05}>
          <Button
            asChild
            variant="ghost"
            size="lg"
            className={cn(
              "group p-0 relative h-14 w-14 rounded-full backdrop-blur-sm transition-all duration-300",
              "hover:border-gray-500 hover:scale-110 hover:shadow-lg hover:shadow-white/10",
